...
public partial class DocumentGroupingEngineView : UserControl
{
    ...
    private readonly DocumentGroupingEngineModule _module;
    ...
    public DocumentGroupingEngineView()
    {
        InitializeComponent();

        _module = new DocumentGroupingEngineModule(LoadConfiguration());
    ...
    private static StackPanel BuildBtnContent(string icon, string label)
    {
        ...
        sp.Children.Add(new TextBlock { Text = icon, FontSize = 11, Margin = new Thickness(0, 0, 7, 0), VerticalAlignment = VerticalAlignment.Center });
